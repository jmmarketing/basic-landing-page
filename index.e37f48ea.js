...
var _countdownView = require("./views/countdownView");
var _countdownViewDefault = parcelHelpers.interopDefault(_countdownView);
...
var _signupView = require("./views/signupView");
...
async function showHome() {
    try {
        (0, _countdownViewDefault.default)._destoryTimer();
        document.body.className = "home-page";
        await (0, _homeViewDefault.default).render();
        (0, _countdownViewDefault.default)._startTimer();
    } catch (error) {
...
async function showSignup() {
    try {
        ...
        await (0, _signupViewDefault.default).render();
        (0, _countdownViewDefault.default)._startTimer();
        (0, _formViewDefault.default)._initFormBehavior();
    } catch (error) {
        console.error(`Failed to load page: ${error}`);
    }
}
...
},{"aa6765693e58a0fe":"9fY7y","a68ecfcbf29c46f6":"148ka","7087588d33667af2":"l3Kyn","864edee099e8affb":"888a9","3a3a5a2cfab86f21":"lApyY","cff2c830bdea4f24":"RsFXo","58a74f00cee1ac64":"b9O3D"}],"jy7Rf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class CountdownTimer {
    ...
    _runCountdown() {
        ...
        if (days !== this._daysCard.value) this._daysCard.textContent = days < 10 ? "0" + days.toString() : days;
        if (hours !== this._hoursCard.value) this._hoursCard.textContent = hours < 10 ? "0" + hours.toString() : hours;
        if (min !== this._minCard.value) this._minCard.textContent = min < 10 ? "0" + min.toString() : min;
        if (sec !== this._secCard.value) this._secCard.textContent = sec < 10 ? "0" + sec.toString() : sec;
        //   console.log(typeof sec);
        if (timeLeft < 0) clearInterval(this._timer);
    }
}
exports.default = new CountdownTimer();
...
},{}],"aTsny":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SignupFormView {
    ...
    _setListeners() {
        ...
        [
            this._nameInput,
            this._emailInput
        ].forEach((input)=>input.addEventListener("change", this._checkInput.bind(this)));
        //Submit Form
    ...
    _customSelectUI(e) {
        if (e.target == this._select) // console.log("Select Clicked!");
    ...
    _submitForm(e) {
        ...
        if (!isValid) {
            ...
            [
                this._nameInput,
                this._emailInput
            ].forEach((field)=>this._checkInput(field));
            return;
        }
...
exports.default = new SignupFormView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kxSlf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _homeTemplateJs = require("../../../templates/homeTemplate.js");
class HomeView {
    constructor(){
        this.container = document.querySelector("body");
    }
    render() {
        const template = (0, _homeTemplateJs.homeTemplate) + (0, _homeTemplateJs.homeFooter);
...
},{"../../../templates/homeTemplate.js":"kdwj1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kdwj1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "homeTemplate", ()=>homeTemplate);
parcelHelpers.export(exports, "homeFooter", ()=>homeFooter);
var _logoSvg = require("../assets/shared/logo.svg");
var _logoSvgDefault = parcelHelpers.interopDefault(_logoSvg);
var _illustrationChartsSvg = require("../assets/home/illustration-charts.svg");
var _illustrationChartsSvgDefault = parcelHelpers.interopDefault(_illustrationChartsSvg);
var _buttonJs = require("../src/components/button.js");
var _priceCardJs = require("../src/components/priceCard.js");
var _logoJs = require("../src/components/logo.js");
var _countdownCardJs = require("../src/components/countdownCard.js");
const homeTemplate = `
    <main class="main">
     ${(0, _logoJs.logoBarComponent)((0, _logoSvgDefault.default))}
      <section class="hero">
        <div class="hero__left">
          ...
          ${(0, _buttonJs.buttonComponent)()}
        </div>
        <div class="hero__right">
          <img
            src="${(0, _illustrationChartsSvgDefault.default)}"
      ...
      <section class="pricing">
        <div class="pricing__card-container">
          ${(0, _priceCardJs.priceCardComponent)("white", "Basic", "Free", "Up to 5 users for free", [
    ...
    text: "Try for Free"
          ...
          <!--PLACE HOLDER -->
          ${(0, _priceCardJs.priceCardComponent)("blue", "Pro", "$9.99", "Per user, billed monthly", [
    ...
    text: "Try for Free"
          ...
          <!--PLACE HOLDER -->
            ${(0, _priceCardJs.priceCardComponent)("white", "Ultimate", "$19.99", "Per user, billed monthly", [
    ...
    text: "Try for Free"
        ...
        <div class="countdown">
          ...
          ${(0, _countdownCardJs.countdownCardComponent)({
    label: "days",
    number: 0
})}
          ${(0, _countdownCardJs.countdownCardComponent)({
    ...
    number: 0
          ...
          ${(0, _buttonJs.buttonComponent)("/signup", "blue", "Get Started", false)}
        </div>
      </section>
    </main>
`;
const homeFooter = `<footer class="footer"></footer>`;

},{"../assets/shared/logo.svg":"8prEp","../assets/home/illustration-charts.svg":"jsUnE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../src/components/button.js":"le2UX","../src/components/priceCard.js":"9YcEl","../src/components/logo.js":"imSQo","../src/components/countdownCard.js":"ik4an"}],"8prEp":[function(require,module,exports) {
module.exports = require("3bb1323a74ad8614").getBundleURL("hWUTQ") + "logo.e51a0e4d.svg" + "?" + Date.now();

},{"3bb1323a74ad8614":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"jsUnE":[function(require,module,exports) {
module.exports = require("102521b5c67636ea").getBundleURL("hWUTQ") + "illustration-charts.33efbc79.svg" + "?" + Date.now();

},{"102521b5c67636ea":"lgJ39"}],"le2UX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buttonComponent", ()=>buttonComponent);
const buttonComponent = (path = "/signup", color = "blue", text = "Get Started", shadow = true)=>`
<a data-nav="${path}">
<button class="button button--${color} ${shadow ? "" : "no-shadow"}">${text}</button>
</a>

`;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9YcEl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "priceCardComponent", ()=>priceCardComponent);
var _buttonJs = require("./button.js");
const priceCardComponent = (color = "white", plan = "Basic", price = "Free", users = "Up to 5 users for free", details = [
    "Detail 1",
    "Detail 2",
    "Detail 3"
], buttonConfig = {
 ...
 <div class="card" data-color="${color}">
    <div class="card__price">
     ...
     ${(0, _buttonJs.buttonComponent)(buttonConfig.path, buttonConfig.color, buttonConfig.text)}
</div>
`;

},{"./button.js":"le2UX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"imSQo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "logoBarComponent", ()=>logoBarComponent);
const logoBarComponent = (logo)=>`
<section class="logo">
        <a data-nav="/"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ik4an":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "countdownCardComponent", ()=>countdownCardComponent);
const countdownCardComponent = (config = {})=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Qbus":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _signupTemplateJs = require("../../../templates/signupTemplate.js");
class SignupView {
    constructor(){
        this.container = document.querySelector("body");
    }
    render() {
        const template = (0, _signupTemplateJs.signupTemplate);
        this.container.innerHTML = template;
    // this._updateNavigationLinks();
    }
}
...
},{"../../../templates/signupTemplate.js":"8vnmz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8vnmz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../assets/shared/logo.svg":"8prEp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../src/components/logo.js":"imSQo","../src/components/countdownCard.js":"ik4an"}],"jSUBV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
