...
document.addEventListener("click", (e)=>{
    if (e.target == select) // console.log("Select Clicked!");
...
[
    nameInput,
    emailInput
].forEach((input)=>input.addEventListener("change", checkInput));
form.addEventListener("submit", (e)=>{
    ...
    if (!isValid) {
        ...
        [
            nameInput,
            emailInput
        ].forEach((field)=>checkInput(field));
        return;
    }
...
//# sourceMappingURL=signup.09c24910.js.map
